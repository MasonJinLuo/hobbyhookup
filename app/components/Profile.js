...
//                   <h4 id="userHobby1"> Hobby </h4>
//                   <a href="#">
//                     <img src="http://placehold.it/800x600" className="thumbnail img-responsive"></img>
//                   </a>
//                 </div>
//                 <div className="col-lg-4 col-sm-6 col-xs-12">
//                   <h4 id="userHobby2"> Hobby </h4>
//                   <a href="#">
//                     <img src="http://placehold.it/800x600" className="thumbnail img-responsive"></img>
//                   </a>
//                 </div>
//                 <div className="col-lg-4 col-sm-6 col-xs-12">
//                   <h4 id="userHobby3"> Hobby </h4>
//                   <a href="#">
//                     <img src="http://placehold.it/800x600" className="thumbnail img-responsive"></img>
//                   </a>
//                 </div>
//                 <div className="col-lg-4 col-sm-6 col-xs-12">
//                   <h4 id="userHobby4"> Hobby </h4>
//                   <a href="#">
//                     <img src="http://placehold.it/800x600" className="thumbnail img-responsive"></img>
//                   </a>
//                 </div>
//                 <div className="col-lg-4 col-sm-6 col-xs-12">
//                   <h4 id="userHobby5"> Hobby </h4>
//                   <a href="#">
//                     <img src="http://placehold.it/800x600" className="thumbnail img-responsive"></img>
//                   </a>
//                 </div>
//                 <div className="col-lg-4 col-sm-6 col-xs-12">
//                   <h4 id="userHobby6"> Hobby </h4>
//                   <a href="#">
//                     <img src="http://placehold.it/800x600" className="thumbnail img-responsive"></img>
//                   </a>
//                 </div>
