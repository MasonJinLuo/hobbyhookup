...
var HobbyPhotography = React.createClass({
	componentDidMount() {
        window.scrollTo(0, 0);
	},
	...
	render: function(){
		...
		<div id='main'>
			<article className="post featured">
				...
				<a href="#" className="image main"><img src="http://www.showcaseocala.com/wp-content/uploads/2016/06/Photography-Camera-HD-Wallpaper1.jpg" alt="" /></a>
...
module.exports = HobbyPhotography;