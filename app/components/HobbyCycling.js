...
var HobbyCycling = React.createClass({
	componentDidMount() {
        window.scrollTo(0, 0);
		...
		<div id='main'>
			<article className="post featured">
				<header className="major">
					<h2><a href="#">Cycling</a></h2>				
				</header>
				<a href="#" className="image main"><img src="http://www.vuelio.com/uk/wp-content/uploads/2016/07/cycling-blog-ranking.jpg" alt="" /></a>
