...
var HobbySpeedReading = React.createClass({
	componentDidMount() {
        window.scrollTo(0, 0);
	},
		...
		<div id='main'>
			<article className="post featured">
				<header className="major">
					<h2><a href="#">Speed Reading</a></h2>				
				</header>
				<a href="#" className="image main"><img src="http://www.zerotoskill.com/wp-content/uploads/2016/03/speed-reading.jpg" alt="" /></a>
...
module.exports = HobbySpeedReading;